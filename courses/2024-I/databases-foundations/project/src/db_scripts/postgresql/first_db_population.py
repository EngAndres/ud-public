...
postgres_engine = create_engine(
    "postgresql://ud_admin:Admin12345@localhost:5432/ud_db_project"
)
...
# =========================================================================================
# Reflect the country table for PostgreSQL
country = Table("country", metadata, autoload_with=postgres_engine)

# Start a new connection for PostgreSQL
with postgres_engine.connect() as connection:
    # Generate 10 fake country entries
    for _ in range(10):
        # Generate a fake country name
        country_name = fake.country()[:25]  # Truncate to 25 characters
...
# =========================================================================================
# Reflect the musical_genre table for PostgreSQL
musical_genre = Table("musical_genre", metadata, autoload_with=postgres_engine)
...
# =========================================================================================
# Reflect the community table for PostgreSQL
community = Table("community", metadata, autoload_with=postgres_engine)
...
# =========================================================================================
# Reflect the users, musical_genre, and country tables for PostgreSQL
users = Table("users", metadata, autoload_with=postgres_engine)
...
# =========================================================================================
# Reflect the community_user_rel, community, and users tables for PostgreSQL
community_user_rel = Table('community_user_rel', metadata, autoload_with=postgres_engine)
...
# =========================================================================================
# Reflect the playlist and users tables for PostgreSQL
playlist = Table('playlist', metadata, autoload_with=postgres_engine)
