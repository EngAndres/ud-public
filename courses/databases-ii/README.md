...
This course is designed to introduce _undergraduate students_ to advanced topics in **database systems** and _good practices_ in both _database design_ and _basic implementation_. Although this is **not** a course solely focused on **software engineering**, it covers the main concepts of _software systems building_.

Classes will consist of _lectures_, **discussions**, and **practical examples**. You will also be required to complete some readings in _software development_. In addition, there will be a **semester-long project**, along with _one_ **final test**, _three_ **workshops**, and _ten_ additional **assignments**.
